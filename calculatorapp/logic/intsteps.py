...
#
# from calculatorapp.logic.stepprinter import functionnames, Rule, replace_u_var, HTMLPrinter
#
...
#
#
# class HTMLPrinter(IntegralPrinter,HTMLPrinter):
#     def __init__(self, rule):
#         self.alternative_functions_printed = set()
#         HTMLPrinter.__init__(self)
